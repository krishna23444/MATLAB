...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function gets an encoded message 'data_deintop(encoded by a convolutional encoder) 
%as argument and returns the decoded message 'dec_op' 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [dec_op]=viterbidec(data_deintop)


%Concatenate two consecutive bits of recieved encoded sequence to 
%make up a symbol
input=[];
for j=1:2:length(data_deintop)
   input=[ input (data_deintop(j))* 2 + (data_deintop(j+1))];
end
