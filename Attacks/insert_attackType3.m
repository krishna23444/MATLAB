...
%
function insert_attackType3(fid,ATTACKCLASS,classlist,weight,labels,refs)
count=1;P=[];
for attack={classlist}
	 P=makeP(P,count,char(attack),weight,labels,refs); 
	 count=count+1;
 end
 insert_attackType2(fid,P.AT,ATTACKCLASS);
