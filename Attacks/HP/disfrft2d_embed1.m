...
for (kk = 1:length(message_pad))
    ...
    dct_block=disfrct2D(cover_object(1:blocksize,1:blocksize),.97,0);
    ...
    dct_block=disfrct2D(dct_block,-.97,0);
...
% watermarked_image_int1=addnoise(watermarked_image_int,80);
...
% display watermarked image
 ...
 title('Watermarked Image Using Fractional Discrete Cosine Transform')
