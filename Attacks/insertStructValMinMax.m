  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 % either isnerts a value, a minimum, maximum or both for the compression value
     % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
function insertStructValMinMax(fid,s1)

testval=~(isempty(s1.value));
if (testval)
	[a,b]=strtok(s1.value);
	while ~isempty(a)
		inserttag(fid,'value',a);
		[a,b]=strtok(b);
	end
end

if  isfield(s1,'min')
%  sprintf('inserting min')
%  s1.min
  if ~isempty(s1.min)
    insertmin(fid,s1.min);
  end
