...
%
function []=startgroup(fid,groupcount,groupweight,groupname)
 groupref=groupname;

 % groupref=sprintf('group%d',groupcount);
 begintagw(fid,'attackGroup',groupref,groupweight); 
 inserttag(fid,'name',groupname);
