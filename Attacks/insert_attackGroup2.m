...
%
function insert_attackGroup2(fid,attackclass,weight,labels,refs,tag3)
 P=[];
 P=makeP(P,char(attackclass),weight,labels,refs); 
 insert_attackType(fid,tag3,P.AT.ref,P.AT.weight,P.AT.refs);
return