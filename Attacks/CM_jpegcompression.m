...
% NOTE: jpeg compression is inlcuded at the end so this function just 
% returns the original image. However it is necessary for consistency
% of the complete framework
function imout =CM_jpegcompression(P,imin)
imout=imin;