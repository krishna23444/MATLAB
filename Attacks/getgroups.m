function G = getgroups(filename)
% getgroups Get attack group names from file.
% getgroups(filename) reads all group names in the text data 
% file 'filename'. In return we get a matrix with the group
