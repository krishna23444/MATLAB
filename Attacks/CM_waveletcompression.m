...
% NOTE: wavelet compression is inlcuded at the end so this function just 
% returns the original image.  wavelet compression is applied by the
% JASPER compression program
function imout =CM_waveletcompression(P,imin)
imout=imin;