...
%
function insertvalminmax(fid,tag2,val1,val2)
  if strcmp(tag2,'value')==1
	 inserttag(fid,'value',val1);
 elseif strcmp(tag2,'min')
	 insertmin(fid,val1);
 elseif strcmp(tag2,'max')
	 insertmax(fid,val1);
 elseif strcmp(tag2,'minmax')
	 insertminmax(fid,val1,val2);
 end
