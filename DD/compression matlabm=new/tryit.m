...
m=512;
n=512;
a=imread('D:\MATLAB 2010 Portable\bin\DD\dnew\images\intersection2.gif');
...
encoded=blkproc(a,[8,8],'fracF2D',.91,.91);

encoded(abs(encoded)<b(i))=0;

decoded=round(blkproc(encoded,[8,8],'fracF2D1',-.91,-.91));
