...
hh=abs(H1)/pi;
 plot(w1/pi,hh,'k','LineWidth',1.2);
hold on
grid on

plot(maw1/pi,u,'c','LineWidth',1.2)
plot(maw1/pi,abs(ma1),'r','LineWidth',1.2)
...
delta = .05;         % maximum passband ripple in dB (+/- around 0 dB)
...
plot(maw1(1:th(1))/pi,E(1:th)*1000/pi,'k','LineWidth',1.2)
hold on
...
th=find(E*1000/pi>=10);
plot(maw1(1:th(1))/pi,E(1:th)*1000/pi,'r','LineWidth',1.2)
grid on
...
th=find(E*1000/pi>=10);
plot(maw1(1:th(1))/pi,E(1:th)*1000/pi,'LineWidth',1.2)
grid on
for i=1:R/2
    E(i)=u(i)-hoc(i);
end
th=find(E*1000/pi>=10);
plot(maw1(1:th(1))/pi,E(1:th)*1000/pi,'g','LineWidth',1.2)
...
plot(maw1(1:th(1))/pi,E(1:th)*1000/pi,'y','LineWidth',1.2);xlabel('Frequency (Hz)');ylabel('%age error');
