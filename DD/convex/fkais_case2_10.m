...
%% convex optimization 
v=1;
wstop = 0.953*pi;        % stopband start freq (in radians)
TOL = 1e-3; 
n = 14;                 % filter order (2n+1 is the full order)
wpass = 0.70*pi;        % passband cutoff freq (in radians)
delta = .2;              % max (+/-) passband ripple in dB
...
%% parks-mcclellan
load('D:\MATLAB 2010 Portable\bin\fipm7.mat')
