...
clear all
close all
mm=4000; n = 5; v=1.5; lbd=.9; wpass = 0.9*pi; wstop = pi; atten_level = -50;
...
convex=(((fx(1)+fx(end))/2)+(sum(fx(2:end-1))))*lbd/pt;
...
freqapprox =(((fx1(1)+fx1(end))/2)+(sum(fx1(2:end-1))))*lbd/pt;
% su(bz)=sum(fx)
